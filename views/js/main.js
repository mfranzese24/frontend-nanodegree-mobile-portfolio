...
var resizePizzas = function(size) { 
  ...
  //add var pizzaContainer to avoid multiple document.querySelectors
  //moved all variables outside of for loop - only need to be calculated once
...
//change loop only to run to 50, rather than 200
